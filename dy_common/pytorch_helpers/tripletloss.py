"""
Triplet loss in pytorch from https://github.com/NegatioN/OnlineMiningTripletLoss, which itself is ported from tf code
from https://omoindrot.github.io/triplet-loss, which has an explanation of the method.
"""
import torch
